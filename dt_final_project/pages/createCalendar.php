...
<?php
    ...
    function build_calendar($month,$year) {
        ...
        // Completar la lista de la última semana si es necesario
        if ($dayOfWeek != 7) {
    ...
    //SI existe la cookie calendar empleamos sus datos para crear el calendario, sino se hace con el mes y año actual
