<?php
	...
	//Use connection.php to access the functions that are needed.
...
<!-- HTML account creation form:
	...
	In this form it is introduced the user name, mail, the new password and the re-write of the new password.
 -->
<html>
	<head>
